...
```{r}
polarTraces <- makeTracesPolar(myXY_data = myXY_data, origin.algorithm = "BottomMean")
plotTraces(myXY_data = myXY_data, compiledList = polarTraces, legend.size = 1, palette = c(
  
  "#FF3366", "#0000FF"
), maskCategories = c("back vowels: u, ɯ, o, ɑ", "front vowels: i, y, e, ø"), pdf.filename = "P03_combined.pdf", legend.position = "bottomright")
#
```
```{r}
polarTraces <-  makeTracesPolar(myXY_data = myXY_data, origin.algorithm = "BottomMean")
