...
plotTraces(rawTraces, mergeCategories = c(TRUE), pdf.filename = "tatarkq.pdf", tiernameAll = c("segments", "segments", "segments", "segments", "segments", "segments", "segments", "segments", NA), categoriesAll = list(c('a'), c('i'), c('ʊ'), c('u'), c('ʏ'), c('y'), c('ə'), c('ɘ'), NA), layersAll = c('Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Palate'), maskCategories = c("a", "i", "ʊ", "u", "ʏ", "y", "ə", "ɘ", "Palate"), means.styles = c(1,1,2,2,3,3,4,4,1))
