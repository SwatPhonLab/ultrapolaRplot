...
plotTraces(myXY_data = myXY_data, compiledList = polarTraces, palette = c(
  "#FF3366", "#FF3366",
  "#faacf5", "#faacf5", 
  "#0000FF", "#0000FF",  
  "#99BBFF", "#99BBFF"
), legend.position = "bottomright", points.display = FALSE, bands.lines = TRUE, bands.fill = TRUE, transparency = 0.37, mean.lines = TRUE, means.styles =  c(2, 1, 2, 1, 1, 2, 1, 2), plot.labels = TRUE, plot.ticks = TRUE, legend.size = 1, legend.linewidth = 1.5, means.linewidth = 1.5, tick.size = 1, bands.linewidth = .3, pdf.filename = "ok4.pdf")
```
