...
find_intersection_with_ray_difference_plot <- function(formatedData, dataOfEachCurveNNj, uniqueSegments, rayIncrement, angle = 1.57, x_coor, y_coor){ #ie compiledList
  ...
  for (segment in 1:length(uniqueSegments)){
    ...
    angleIntersection[[uniqueSegments[[segment]]]] <- matrix(NA, nrow = length(formatedData[[segment]]), ncol = 6)
  }
  #end set up
  angleRay = angle
          ...
          #find the right two points the angle falls between for each individual trace
           ...
           if (angleRay <= formatedData[[segment]][[individualTrace]][3, individualPoint +1]){
             if (angleRay >= formatedData[[segment]][[individualTrace]][3, individualPoint]){ 
               ...
               if (formatedData[[segment]][[individualTrace]][3, individualPoint+1] >= formatedData[[segment]][[individualTrace]][3, individualPoint]){
                 if (formatedData[[segment]][[individualTrace]][3, individualPoint+1] - formatedData[[segment]][[individualTrace]][3, individualPoint] < pi){
  ...
  # print("angle entry, radiusPrevious, radiusNext, anglePrevious, angleRay, angleNext")
