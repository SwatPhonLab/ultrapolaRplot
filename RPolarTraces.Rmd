...
loadTraces <- function(directory_name, tiername = "", categories = c()){
  ...
  metaDataFile <- paste(directory_name, "metadata3.json", sep = "/") #is this an ok approach?
  ...
  traces_raw <- metaData$traces["Palate"] #unnecessary
...
myXY_data <- loadTraces(directory_name = "/Users/yayaorigami/Documents/plinguistics/Dataset3")
myXY_data
```
```{r}
