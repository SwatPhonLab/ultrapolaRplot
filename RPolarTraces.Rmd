...
# plotTraces(rawTraces, tiernameAll = c("cons2", "cons2", "cons2", "cons2", "cons2", NA), categoriesAll = list(c('sʲ.#_V.F', 'sʲ.V_#.F', 'sʲ.V_V.FF', 'zʲ.V_V.FF'), c('sˠ.#_V.F', 'sˠ.V_#.F', 'sˠ.V_V.FF', 'zˠ.V_#.F'), c('zˠ.V_#.M', 'zˠ.V_V.MM'), c('sʲ.#_V.B', 'sʲ.V_#.B', 'sʲ.V_V.BB', 'zʲ.V_#.B'), c('sˠ.#_V.B', 'sˠ.V_#.B', 'sˠ.V_V.BB', 'zˠ.V_#.B'), NA), layersAll = c('tongue', 'tongue', 'tongue', 'tongue', 'tongue', 'palate'), mergeCategories = TRUE)
#, maskCategories = c("SʲV[-bk]", "SˠV[-bk]", "SˠV[mid]", "SʲV[+bk]", "SˠV[+bk]", "Palate"))

# plotTraces(rawTraces, mergeCategories = c(TRUE), tiernameAll = c("segments", "segments", "segments", "segments", "segments", "segments", "segments", "segments", NA), categoriesAll = list(c('a'), c('i'), c('ʊ'), c('u'), c('ʏ'), c('y'), c('ə'), c('ɘ'), NA), layersAll = c('Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Palate'), maskCategories = c("a", "i", "ʊ", "u", "ʏ", "y", "ə", "ɘ", "Palate"), means.styles = c(1,1,2,2,3,3,4,4,1), rays = list(c(0, 0.5, .7), c(0, 0.6, .7)))

plotTraces(rawTraces, categoriesAll = list(c("i", "y", "ɯ", "u", "e", "ø", "o", "a")), rays = list(c(0.05, 0.5, .5)))

plotTraces(rawTraces, mergeCategories = c(TRUE), categoriesAll = list(c("y", "ø", "u", "o"), c("i", "e", "ɯ", "a")), maskCategories = c("rounded", "unrounded"), rays = list(c(0.05, 0.5, .5)))

filteredTraces <- plotTraces(rawTraces, mergeCategories = c(TRUE), categoriesAll = list(c("i", "y", "e", "ø"), c("ɯ", "u", "a", "o")), maskCategories = c("front vowels", "back vowels"), rays = list(c(0.05, 0.5, 1.6)))

plotTraces(rawTraces, mergeCategories = c(TRUE), categoriesAll = list(c("i", "y", "ɯ", "u"), c("e", "ø", "o", "a")), maskCategories = c("high", "mid"), rays = list(c(0.05, 0.5, .5)))

# plotTraces(rawTraces, mergeCategories = c(TRUE), tiernameAll = c("segments", "segments", "segments", "segments", "segments", "segments", "segments", "segments", NA), categoriesAll = list(c('a'), c('i'), c('ʊ'), c('u'), c('ʏ'), c('y'), c('ə'), c('ɘ'), NA), layersAll = c('Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Tongue', 'Palate'), maskCategories = c("a", "i", "ʊ", "u", "ʏ", "y", "ə", "ɘ", "Palate"), means.styles = c(1,1,2,2,3,3,4,4,1))
...
pairwise_comparison(filteredTraces, x_coor = 0.05, y_coor = 0.5, angle = 1.6)
```
