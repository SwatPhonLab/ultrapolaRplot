...
plotTraces(myXY_data = myXY_data, compiledList = polarTraces, palette = my_palette1, legend.position = "center", points.display = TRUE, bands.lines = TRUE, bands.fill = TRUE, legend.size = 0.65, transparency = 0.1, pdf.filename = "~/Desktop/testingFilenameUltraPlot")
```
