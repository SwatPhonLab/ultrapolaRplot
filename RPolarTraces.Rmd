...
```{r}
# calculateIntersection3 <- function(xP, yP, radiusPrevious, anglePrevious, angleRay, xN, yN, radiusNext, angleNext, x_coor = 0, y_coor = 0){
# 
#   #print("radius Next")
#   #print(radiusNext)
#   
#   distance_between_points = ((xN - xP)^2 + (yN - yP)^2)^0.5
#   #print("distancce between points")
#   #print(distance_between_points)
#   big_angle = (angleNext - anglePrevious) 
#   #print("big angle")
#   #print(big_angle)
#   small_angle = (angleRay - anglePrevious)
#   #print("small angle")
#   #print(small_angle)
#   
#   origin_x = x_coor
...
#   
#   #print("B")
#   #print(radiusNext*sin(big_angle)/distance_between_points)
#   #angleB = asin(radiusNext*sin(big_angle)/distance_between_points)
#   val <- radiusNext * sin(big_angle) / distance_between_points
#   val <- max(-1, min(1, val))
#   angleB <- asin(val)
#   #print(angleB)
#   #print("b")
#   angleb = pi - angleB - small_angle
#   #print(angleb)
#   
#   #print("intersection")
#   intersection = sin(angleB)* radiusPrevious/sin(angleb)
#   #print(intersection)
#   
#   return (intersection)
# }
  ...
  angleRay = angle
    ...
    for (segment in 1:length(uniqueSegments)){ #and for each segment
     ...
     for (individualTrace in seq(length(dataOfEachCurveNNj[[segment]]))){ #for each trace in the segment (alphabetical??)
        #want to limit search, cut out half that does not correspond to direction of angle
        # n_cols <- length(formatedData[[segment]][[individualTrace]][1,all()])
        # print(n_cols)
        # if (angleRay >= pi/2){
        #   formatedData <- formatedData[[segment]][[individualTrace]][all(), 1:floor(n_cols/2)]
        # }
        # if (angleRay < pi/2){
        #   #angle 0 is at very end of array
        #   formatedData <- formatedData[[segment]][[individualTrace]][all(), (floor(n_cols/2)):n_cols]
        # }
       
       # if (individualTrace == 3 && segment == 1){
       #   print(formatedData[[segment]][[individualTrace]]) 
       # }
...
# bestFitRays.intersection_rays.negative = c(0.25,0.7), bestFitRays.intersection_rays.positive = c(0.15),
