...
plotTraces(myXY_data = myXY_data, compiledList = polarTraces, myPalette = my_palette1, legend.position = "topleft", points.display = FALSE, bands.lines = TRUE, bands.fill = TRUE)
```
