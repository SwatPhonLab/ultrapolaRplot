...
plotTraces(myXY_data = myXY_data, compiledList = polarTraces, palette = my_palette1, legend.position = "bottomright", points.display = FALSE, bands.lines = TRUE, bands.fill = TRUE, transparency = 0.3, mean.lines = TRUE, means.styles = c("o", "o", "o", "o"), plot.labels = TRUE, plot.ticks = FALSE, png.filename = "ok2.png")
```
