...
filteredTraces <- plotTraces(rawTraces, mergeCategories = c(TRUE), tiernameAll = c("vow", "vow", "vow"), categoriesAll = list(c('u'), c('a'), c('ɔ')),  maskCategories = c("u", "ɑ", "ɔ"), palette = c(DarkRed, DarkBlue, LightBlue), means.styles = c(1,2,1,2,1,2,1,2), legend.size=1.3, legend.position="topleft", legend.linewidth=0.5, bubble = TRUE)
...
# filteredTraces <- plotTraces(rawTraces, mergeCategories = c(TRUE), tiernameAll = c("vow", "vow", "vow", "vow", "vow", "vow", "vow", "vow"), categoriesAll = list(c('i', 'iː'), c('y', 'yː'), c('u'), c('ɯ', 'ɯː'), c('ɛ'), c('œ'), c('a'), c('ɔ')),  maskCategories = c("i/iː", "y/yː", "u", "ɯ/ɯː", "ɛ", "œ", "ɑ", "ɔ"), palette = c(LightBlue, LightBlue, Pink, Pink, DarkBlue, DarkBlue, DarkRed, LightRed), means.styles = c(1,2,1,2,1,2,1,2), legend.size=1.3, legend.position="topleft", bubble = TRUE)
# 
