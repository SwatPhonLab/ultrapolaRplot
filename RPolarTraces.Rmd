...
myXY_data <- loadTraces(directory_name, c("o","i","e"))
myXY_data
```
```{r}
polarTraces <- makeTracesPolar(myXY_data = myXY_data, origin.algorithm = "BottomMean", scaling.factor = 592/412)
plotTraces(myXY_data = myXY_data, compiledList = polarTraces, palette = my_palette1, legend.position = "center", points.display = FALSE, bands.lines = TRUE, bands.fill = TRUE, legend.size = 0.65, transparency = 0.37)
```
